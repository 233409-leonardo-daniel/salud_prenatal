...
/// Placeholder animado (pulso de opacidad) genérico: da la animación, cada
/// caller define la forma de sus filas vía [itemBuilder]. `AppColors.skeletonBase`
/// (usado por los itemBuilders de abajo) se deriva del tema, así siempre
/// contrasta con el fondo que lo contiene en vez de depender de un hex fijo
/// que puede desincronizarse (eso causó el bug del skeleton invisible).
class _PulsingSkeleton extends StatefulWidget {
  final int itemCount;
  final IndexedWidgetBuilder itemBuilder;

  const _PulsingSkeleton({required this.itemCount, required this.itemBuilder});
