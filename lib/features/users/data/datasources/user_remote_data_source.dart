...
class UserRemoteDataSourceImpl implements UserRemoteDataSource {
  ...
  Future<List<UserDto>> getPatients({int? doctorId}) async {
    try {
      ...
      // Fallback offline mock en caso de error de conexión
      if (e.toString().contains('SocketException') || 
          e.toString().contains('Connection refused') || 
          e.toString().contains('ClientException')) {
        return [
          UserDto(id: 2, email: 'maria.lopez@gmail.com', fullName: 'María López', role: 'paciente'),
          UserDto(id: 3, email: 'lucia.martinez@gmail.com', fullName: 'Lucía Martínez', role: 'paciente'),
        ];
      }
      rethrow;
    }
